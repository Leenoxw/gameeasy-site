...
export const gamesData = [
  ...
  { 
    id: 'the-forest', title: "The Forest", image: "/gameeasy-site/images/the-forest.jpg", cat: "Survie / Horreur", mode: "Solo / Multi",
  ...
  { 
    id: 'battlefield-2042', title: "Battlefield 2042", image: "/gameeasy-site/images/bf2042.jpg", cat: "FPS / Action", mode: "Multi",
  ...
  { 
    id: 'halo-infinite', title: "Halo Infinite", image: "/gameeasy-site/images/halo.jpg", cat: "FPS / Sci-Fi", mode: "Solo / Multi",
  ...
  { 
    id: 'titanfall-2', title: "Titanfall 2", image: "/gameeasy-site/images/titanfall2.jpg", cat: "FPS / Sci-Fi", mode: "Solo / Multi",
  ...
  { 
    id: 'resident-evil-village', title: "RE Village", image: "/gameeasy-site/images/revillage.jpg", cat: "Horreur", mode: "Solo",
  ...
  { 
    id: 'amnesia-the-bunker', title: "Amnesia: The Bunker", image: "/gameeasy-site/images/amnesia-bunker.jpg", cat: "Horreur", mode: "Solo",
  ...
  { 
    id: 'dead-by-daylight', title: "Dead by Daylight", image: "/gameeasy-site/images/dbd.jpg", cat: "Horreur / Multi", mode: "Multi",
  ...
  { 
    id: 'days-gone', title: "Days Gone", image: "/gameeasy-site/images/daysgone.jpg", cat: "Action / Open World", mode: "Solo",
  ...
  { 
    id: 'assassins-creed-odyssey', title: "AC Odyssey", image: "/gameeasy-site/images/odyssey.jpg", cat: "Aventure / RPG", mode: "Solo",
  ...
  { 
    id: 'mafia-definitive-edition', title: "Mafia: Def. Edition", image: "/gameeasy-site/images/mafia.jpg", cat: "Action / Aventure", mode: "Solo",
  ...
  { 
    id: 'need-for-speed-unbound', title: "NFS Unbound", image: "/gameeasy-site/images/nfsunbound.jpg", cat: "Course", mode: "Solo / Multi",
  ...
  { 
    id: 'dirt-5', title: "DiRT 5", image: "/gameeasy-site/images/dirt5.jpg", cat: "Course", mode: "Solo / Multi",
  ...
  { 
    id: 'vampire-survivors', title: "Vampire Survivors", image: "/gameeasy-site/images/vampire.jpg", cat: "Indie / Roguelike", mode: "Solo",
  ...
  { 
    id: 'dredge', title: "DREDGE", image: "/gameeasy-site/images/dredge.jpg", cat: "Indie / Aventure", mode: "Solo",
  ...
  { 
    id: 'space-marine-2', title: "Warhammer 40k: Space Marine 2", image: "/gameeasy-site/images/sm2.jpg", cat: "Action / FPS", mode: "Solo / Multi",
  ...
  { 
    id: 'hitman-3', title: "Hitman 3", image: "/gameeasy-site/images/hitman3.jpg", cat: "Action / Infiltration", mode: "Solo",
  ...
  { 
    id: 'ghostwire-tokyo', title: "Ghostwire: Tokyo", image: "/gameeasy-site/images/ghostwire.jpg", cat: "Aventure / Fantaisie", mode: "Solo",
  ...
  { 
    id: 'sniper-elite-5', title: "Sniper Elite 5", image: "/gameeasy-site/images/sniper5.jpg", cat: "FPS / Tactique", mode: "Solo / Multi",
  ...
  { 
    id: 'valheim', title: "Valheim", image: "/gameeasy-site/images/valheim.jpg", cat: "Survie / Coop", mode: "Solo / Multi",
  ...
  { 
    id: 'raft', title: "Raft", image: "/gameeasy-site/images/raft.jpg", cat: "Survie", mode: "Solo / Multi",
  ...
  { 
    id: 'grounded', title: "Grounded", image: "/gameeasy-site/images/grounded.jpg", cat: "Survie / Aventure", mode: "Solo / Multi",
  ...
  { 
    id: 'football-manager-24', title: "Football Manager 2024", image: "/gameeasy-site/images/fm24.jpg", cat: "Gestion / Sport", mode: "Solo",
  ...
  { 
    id: 'tropico-6', title: "Tropico 6", image: "/gameeasy-site/images/tropico6.jpg", cat: "Gestion / Stratégie", mode: "Solo / Multi",
  ...
  { 
    id: 'powerwash-sim', title: "PowerWash Simulator", image: "/gameeasy-site/images/powerwash.jpg", cat: "Simulation", mode: "Solo / Multi",
  ...
  { 
    id: 'goat-simulator-3', title: "Goat Simulator 3", image: "/gameeasy-site/images/goat3.jpg", cat: "Simulation / Action", mode: "Solo / Multi",
  ...
  { 
    id: 'slay-the-spire', title: "Slay the Spire", image: "/gameeasy-site/images/slaythespire.jpg", cat: "Roguelike / Cartes", mode: "Solo",
  ...
  { 
    id: 'the-last-of-us-p1', title: "The Last of Us Part I", image: "/gameeasy-site/images/tlou1.jpg", cat: "Action / Aventure", mode: "Solo",
  ...
  { 
    id: 'returnal', title: "Returnal", image: "/gameeasy-site/images/returnal.jpg", cat: "Sci-Fi / Roguelike", mode: "Solo / Multi",
  ...
  { 
    id: 'monster-hunter-rise', title: "Monster Hunter Rise", image: "/gameeasy-site/images/mhrise.jpg", cat: "Action / RPG", mode: "Solo / Multi",
  ...
  { 
    id: 'kcd-2', title: "Kingdom Come: Deliverance II", image: "/gameeasy-site/images/kcd2.jpg", cat: "RPG / Médiéval", mode: "Solo",
  ...
  { 
    id: 'stalker-2', title: "S.T.A.L.K.E.R. 2", image: "/gameeasy-site/images/stalker2.jpg", cat: "FPS / Survie", mode: "Solo",
  ...
  // --- SAGA FAR CRY ---
  { 
    id: 'far-cry-3', title: "Far Cry 3", image: "/gameeasy-site/images/fc3.jpg", cat: "FPS / Action", mode: "Solo",
  ...
  { 
    id: 'far-cry-4', title: "Far Cry 4", image: "/gameeasy-site/images/fc4.jpg", cat: "FPS / Action", mode: "Solo / Multi",
  ...
  { 
    id: 'far-cry-5', title: "Far Cry 5", image: "/gameeasy-site/images/fc5.jpg", cat: "FPS / Action", mode: "Solo / Multi",
  ...
  { 
    id: 'far-cry-6', title: "Far Cry 6", image: "/gameeasy-site/images/fc6.jpg", cat: "FPS / Action", mode: "Solo / Multi",
  ...
  // --- SAGA RESIDENT EVIL ---
  { 
    id: 're-2-remake', title: "Resident Evil 2 Remake", image: "/gameeasy-site/images/re2.jpg", cat: "Horreur", mode: "Solo",
  ...
  { 
    id: 're-3-remake', title: "Resident Evil 3 Remake", image: "/gameeasy-site/images/re3.jpg", cat: "Horreur / Action", mode: "Solo",
  ...
  { 
    id: 're-7-biohazard', title: "Resident Evil 7", image: "/gameeasy-site/images/re7.jpg", cat: "Horreur", mode: "Solo",
  ...
  { 
    id: 'planet-coaster', title: "Planet Coaster", image: "/gameeasy-site/images/pcoaster.jpg", cat: "Simulation / Gestion", mode: "Solo",
  ...
  { 
    id: 'rimworld', title: "RimWorld", image: "/gameeasy-site/images/rimworld.jpg", cat: "Simulation / Indie", mode: "Solo",
  ...
  // --- ACTION / RPG ---
  { 
    id: 'sekiro', title: "Sekiro: Shadows Die Twice", image: "/gameeasy-site/images/sekiro.jpg", cat: "Action / RPG", mode: "Solo",
  ...
  { 
    id: 'dark-souls-3', title: "Dark Souls III", image: "/gameeasy-site/images/ds3.jpg", cat: "Action / RPG", mode: "Solo / Multi",
  ...
  { 
    id: 'dragon-age-veilguard', title: "Dragon Age: The Veilguard", image: "/gameeasy-site/images/dav.jpg", cat: "RPG", mode: "Solo",
  ...
  // --- SAGA CALL OF DUTY ---
  { 
    id: 'cod-mw3-remaster', title: "CoD: Modern Warfare III", image: "/gameeasy-site/images/mw3.jpg", cat: "FPS", mode: "Solo / Multi",
  ...
  { 
    id: 'cod-vanguard', title: "Call of Duty: Vanguard", image: "/gameeasy-site/images/vanguard.jpg", cat: "FPS", mode: "Solo / Multi",
  ...
  { 
    id: 'cod-black-ops-cold-war', title: "CoD: Black Ops Cold War", image: "/gameeasy-site/images/coldwar.jpg", cat: "FPS", mode: "Solo / Multi",
  ...
  // --- STRATÉGIE & GESTION ---
  { 
    id: 'anno-1800', title: "Anno 1800", image: "/gameeasy-site/images/anno1800.jpg", cat: "Stratégie / Gestion", mode: "Solo / Multi",
  ...
  { 
    id: 'total-war-warhammer-3', title: "Total War: Warhammer III", image: "/gameeasy-site/images/tww3.jpg", cat: "Stratégie", mode: "Solo / Multi",
  ...
  { 
    id: 'stellaris', title: "Stellaris", image: "/gameeasy-site/images/stellaris.jpg", cat: "Stratégie / Sci-Fi", mode: "Solo / Multi",
  ...
  // --- SIMULATION & SPORT ---
  { 
    id: 'fc-25', title: "EA SPORTS FC 25", image: "/gameeasy-site/images/fc25.jpg", cat: "Sport", mode: "Solo / Multi",
  ...
  { 
    id: 'nba-2k25', title: "NBA 2K25", image: "/gameeasy-site/images/nba2k25.jpg", cat: "Sport", mode: "Solo / Multi",
  ...
  { 
    id: 'microsoft-flight-sim', title: "Flight Simulator 2024", image: "/gameeasy-site/images/mfs.jpg", cat: "Simulation", mode: "Solo / Multi",
  ...
  // --- ACTION / AVENTURE / RPG ---
  { 
    id: 'ghost-recon-breakpoint', title: "Ghost Recon Breakpoint", image: "/gameeasy-site/images/breakpoint.jpg", cat: "Action / FPS", mode: "Solo / Multi",
  ...
  { 
    id: 'watch-dogs-2', title: "Watch Dogs 2", image: "/gameeasy-site/images/wd2.jpg", cat: "Action / Sci-Fi", mode: "Solo / Multi",
  ...
  { 
    id: 'outer-worlds', title: "The Outer Worlds", image: "/gameeasy-site/images/outerworlds.jpg", cat: "RPG / Sci-Fi", mode: "Solo",
  ...
  { 
    id: 'borderlands-3', title: "Borderlands 3", image: "/gameeasy-site/images/borderlands3.jpg", cat: "Action / FPS", mode: "Solo / Multi",
  ...
  // --- INDIE & AUTRES ---
  { 
    id: 'disco-elysium', title: "Disco Elysium", image: "/gameeasy-site/images/disco.jpg", cat: "RPG / Indie", mode: "Solo",
  ...
  { 
    id: 'outer-wilds', title: "Outer Wilds", image: "/gameeasy-site/images/outerwilds.jpg", cat: "Indie / Aventure", mode: "Solo",
